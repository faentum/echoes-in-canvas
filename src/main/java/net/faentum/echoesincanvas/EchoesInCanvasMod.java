package net.faentum.echoesincanvas;
...
@Mod("echoes_in_canvas")
public class EchoesInCanvasMod {
	public static final Logger LOGGER = LogManager.getLogger(EchoesInCanvasMod.class);
	public static final String MODID = "echoes_in_canvas";

	public EchoesInCanvasMod(IEventBus modEventBus) {
